                      ...
                      modalPagedRows.map((item) => (
                        ...
                        >
                          ...
                          <td className="py-4">
                            ...
                            >
                              {item.status === "IN" ? "IN" : item.status === "OUT" ? "OUT" : (item.status === "auto_checked_out" || item.status === "Auto-out" || item.status.toLowerCase().startsWith("auto")) ? "Auto-OUT" : item.status.replace("_", " ")}
                            </span>
                          </td>
                        </tr>
                      ))
