...
function DataGridToolbarButton({
  ...
  const baseClass = "inline-flex shrink-0 items-center justify-center w-[110px] h-[40px] m-0 p-0 box-border rounded-full border border-solid text-xs font-semibold leading-none transition-all focus:outline-none";
